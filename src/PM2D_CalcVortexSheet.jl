...
Given a geometry of panels, computes the strength of a vortex sheet represented
...
"""
function CalcVortexSheetCoef(panels,RHS::Array{Float64})
...
"""
function CalcVortexSheet(panels::Array{Panel2D},
                         alpha::Array{Float64},
                         X::Array{Float64};
                         sigma::Float64=0.2,
                         a::Float64=1.0)
...
"""
function CalcVortexSheetVelocity(panels::Array{Panel2D},
                                 alpha::Array{Float64},
                                 X::Array{Float64};
                                 smoothRadius=1e-6,
                                 sigma::Float64=0.2,
